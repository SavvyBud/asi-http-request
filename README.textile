Summary:
This clone converts the project to a framework so it is easy for developers to import the functionality.
The project was converted to framework based on information at:
https://github.com/jverkoey/iOS-Framework

About this repo:
This project is a clone of upstream repo (see below)

git remote -v
origin	https://github.com/SavvyBud/asi-http-request.git (push)
upstream	https://github.com/pokeb/asi-http-request.git (fetch)
